...
class TemplateTest(TestCase):
    def test_template_creation(self):
        from OmniDB_app.include.OmniDatabase.SQLite import Template, TemplateType
        template = Template('SELECT * FROM test', TemplateType.EXECUTE)
        self.assertEqual(template.v_text, 'SELECT * FROM test')
        self.assertEqual(template.v_type, TemplateType.EXECUTE)

    def test_template_script_type(self):
        from OmniDB_app.include.OmniDatabase.SQLite import Template, TemplateType
        template = Template('CREATE TABLE...', TemplateType.SCRIPT)
        self.assertEqual(template.v_type, TemplateType.SCRIPT)