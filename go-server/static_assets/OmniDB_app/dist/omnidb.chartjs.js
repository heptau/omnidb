(function() {
  ...
  function requireChart() {
    ...
    (function(module2, exports) {
      (function(global, factory) {
        ...
        helpers2.indexOf = function(array, item, fromIndex) {
        ...
        var controller_line = core_datasetController.extend({
          ...
          update: function(reset) {
            ...
            if (showLine) {
              ...
              line2._scale = me._yScale;
              line2._datasetIndex = me.index;
              line2._children = points;
              line2._model = me._resolveDatasetElementOptions(line2);
              line2.pivot();
            }
            for (i = 0, ilen = points.length; i < ilen; ++i) {
              me.updateElement(points[i], i, reset);
            }
            if (showLine && line2._model.tension !== 0) {
        ...
        function updateDims(chartArea, params, layout) {
          ...
          layout.size = layout.horizontal ? box2.height : box2.width;
          chartArea[layout.pos] += layout.size;
          if (box2.getPadding) {
            var boxPadding = box2.getPadding();
        ...
        function fitBoxes(boxes, chartArea, params) {
          var refitBoxes = [];
          var i, ilen, layout, box2, refit, changed;
          for (i = 0, ilen = boxes.length; i < ilen; ++i) {
            layout = boxes[i];
            box2 = layout.box;
            box2.update(
        ...
        function placeBoxes(boxes, chartArea, params) {
          ...
          var x = chartArea.x;
          var y = chartArea.y;
          var i, ilen, layout, box2;
          for (i = 0, ilen = boxes.length; i < ilen; ++i) {
            layout = boxes[i];
            box2 = layout.box;
            if (layout.horizontal) {
              box2.left = box2.fullWidth ? userPadding.left : chartArea.left;
              box2.right = box2.fullWidth ? params.outerWidth - userPadding.right : chartArea.left + chartArea.w;
              box2.top = y;
              box2.bottom = y + box2.height;
              box2.width = box2.right - box2.left;
              y = box2.bottom;
            } else {
              box2.left = x;
              box2.right = x + box2.width;
              box2.top = chartArea.top;
              box2.bottom = chartArea.top + chartArea.h;
              box2.height = box2.bottom - box2.top;
              x = box2.right;
            }
          }
          chartArea.x = x;
        ...
        function getTooltipSize(tooltip, model) {
          ...
          var widthPadding = 0;
          var maxLineWidth = function(line2) {
        ...
        var exports$4 = core_element.extend({
          ...
          drawBody: function(pt, vm, ctx) {
            ...
            var rtlHelper = getRtlHelper(vm.rtl, vm.x, vm.width);
            var fillLineOfText = function(line2) {
              ctx.fillText(line2, rtlHelper.x(pt.x + xLinePadding), pt.y + bodyFontSize / 2);
          ...
          /** @lends Chart */
          {
            ...
            */
            ...
            updateLayout: function() {
              ...
              me._layers = [];
              helpers$1.each(me.boxes, function(box2) {
                if (box2._configure) {
                  box2._configure();
                }
                me._layers.push.apply(me._layers, box2._layers());
              }, me);
  ...
  function requireHelpers() {
    ...
    helpers = function(Chart2) {
      var chartHelpers = Chart2.helpers;
      function initConfig(config) {
        config = chartHelpers.configMerge(Chart2.Annotation.defaults, config);
        if (chartHelpers.isArray(config.annotations)) {
          config.annotations.forEach(function(annotation2) {
            annotation2.label = chartHelpers.configMerge(Chart2.Annotation.labelDefaults, annotation2.label);
          });
        }
        return config;
      }
      function getScaleLimits(scaleId, annotations, scaleMin, scaleMax) {
        var ranges = annotations.filter(function(annotation2) {
          return !!annotation2._model.ranges[scaleId];
        }).map(function(annotation2) {
          return annotation2._model.ranges[scaleId];
        });
        var min2 = ranges.map(function(range) {
          return Number(range.min);
        }).reduce(function(a, b) {
          return isFinite(b) && !isNaN(b) && b < a ? b : a;
        }, scaleMin);
        var max2 = ranges.map(function(range) {
      ...
      function getNearestItems(annotations, position) {
        var minDistance = Number.POSITIVE_INFINITY;
        return annotations.filter(function(element2) {
          return element2.inRange(position.x, position.y);
        }).reduce(function(nearestItems, element2) {
          var center = element2.getCenterPoint();
  ...
  function requireLine() {
    ...
    hasRequiredLine = 1;
    line = function(Chart2) {
      var chartHelpers = Chart2.helpers;
      var helpers2 = requireHelpers()(Chart2);
      ...
      var LineAnnotation = Chart2.Annotation.Element.extend({
        ...
        configure: function() {
          ...
          var pixel, endPixel;
          if (scale) {
            pixel = helpers2.isValid(options.value) ? scale.getPixelForValue(options.value) : NaN;
            endPixel = helpers2.isValid(options.endValue) ? scale.getPixelForValue(options.endValue) : pixel;
          }
          if (isNaN(pixel)) {
            return;
          }
      ...
      function LineFunction(view) {
        ...
        this.intersects = function(x, y, epsilon) {
          ...
          var dy = this.getY(x), dx = this.getX(y);
      ...
      function calculateLabelPosition(view, width, height, padWidth, padHeight) {
        ...
        switch (true) {
          ...
          case (view.mode == verticalKeyword && view.labelPosition == "top"):
            ...
            ret.y = view.y1 + ya;
            ret.x = (isFinite(line2.m) ? line2.getX(ret.y) : view.x1) - xa;
            break;
          // bottom align
    ...
    box = function(Chart2) {
      ...
      var BoxAnnotation = Chart2.Annotation.Element.extend({
        setDataLimits: function() {
          ...
          var max2 = 0;
          if (xScale) {
            min2 = helpers2.isValid(options.xMin) ? options.xMin : xScale.getPixelForValue(chartArea.left);
            max2 = helpers2.isValid(options.xMax) ? options.xMax : xScale.getPixelForValue(chartArea.right);
          ...
          if (yScale) {
            min2 = helpers2.isValid(options.yMin) ? options.yMin : yScale.getPixelForValue(chartArea.bottom);
            max2 = helpers2.isValid(options.yMax) ? options.yMax : yScale.getPixelForValue(chartArea.top);
        ...
        configure: function() {
          ...
          var min2, max2;
          if (xScale) {
            min2 = helpers2.isValid(options.xMin) ? xScale.getPixelForValue(options.xMin) : chartArea.left;
            max2 = helpers2.isValid(options.xMax) ? xScale.getPixelForValue(options.xMax) : chartArea.right;
            left = Math.min(min2, max2);
            right = Math.max(min2, max2);
          }
          if (yScale) {
            min2 = helpers2.isValid(options.yMin) ? yScale.getPixelForValue(options.yMin) : chartArea.bottom;
            max2 = helpers2.isValid(options.yMax) ? yScale.getPixelForValue(options.yMax) : chartArea.top;
            top = Math.min(min2, max2);
            bottom = Math.max(min2, max2);
          }
          model.left = left;
          model.top = top;
          model.right = right;
  ...
  function requireEvents() {
    ...
    hasRequiredEvents = 1;
    events = function(Chart2) {
      var chartHelpers = Chart2.helpers;
      var helpers2 = requireHelpers()(Chart2);
      function collapseHoverEvents(events2) {
        var hover = false;
        var filteredEvents = events2.filter(function(eventName) {
          switch (eventName) {
            case "mouseenter":
            case "mouseover":
            case "mouseout":
      ...
      function dispatcher(e) {
        ...
        var elements = helpers2.elements(this);
        var position = chartHelpers.getRelativePosition(e, this.chart);
        var element2 = helpers2.getNearestItems(elements, position);
        var events2 = collapseHoverEvents(ns.options.events);
        var dblClickSpeed = ns.options.dblClickSpeed;
        var eventHandlers = [];
        var eventHandlerName = helpers2.getEventHandlerName(e.type);
        var options = (element2 || {}).options;
        if (e.type === "mousemove") {
          if (element2 && !element2.hovering) {
            ["mouseenter", "mouseover"].forEach(function(eventName) {
              var eventHandlerName2 = helpers2.getEventHandlerName(eventName);
              var hoverEvent = helpers2.createMouseEvent(eventName, e);
              element2.hovering = true;
              if (typeof options[eventHandlerName2] === "function") {
                eventHandlers.push([options[eventHandlerName2], hoverEvent, element2]);
              }
            });
          } else if (!element2) {
            elements.forEach(function(element3) {
              if (element3.hovering) {
                element3.hovering = false;
                var options2 = element3.options;
                ["mouseout", "mouseleave"].forEach(function(eventName) {
                  var eventHandlerName2 = helpers2.getEventHandlerName(eventName);
                  var hoverEvent = helpers2.createMouseEvent(eventName, e);
                  if (typeof options2[eventHandlerName2] === "function") {
                    eventHandlers.push([options2[eventHandlerName2], hoverEvent, element3]);
                  }
                });
              }
            });
        ...
        if (element2 && events2.indexOf("dblclick") > -1 && typeof options.onDblclick === "function") {
          if (e.type === "click" && typeof options.onClick === "function") {
            clearTimeout(element2.clickTimeout);
            element2.clickTimeout = setTimeout(function() {
              delete element2.clickTimeout;
              options.onClick.call(element2, e);
            }, dblClickSpeed);
            e.stopImmediatePropagation();
            e.preventDefault();
            return;
          } else if (e.type === "dblclick" && element2.clickTimeout) {
            clearTimeout(element2.clickTimeout);
            delete element2.clickTimeout;
          }
        }
        if (element2 && typeof options[eventHandlerName] === "function" && eventHandlers.length === 0) {
          eventHandlers.push([options[eventHandlerName], e, element2]);
        }
  ...
  function requireAnnotation() {
    ...
    annotation = function(Chart2) {
      var chartHelpers = Chart2.helpers;
      var helpers2 = requireHelpers()(Chart2);
      var events2 = requireEvents()(Chart2);
      var annotationTypes = Chart2.Annotation.types;
      function setAfterDataLimitsHook(axisOptions) {
        helpers2.decorate(axisOptions, "afterDataLimits", function(previous, scale) {
          if (previous) previous(scale);
          helpers2.adjustScaleRange(scale);
        });
      }
      function draw(drawTime) {
        return function(chartInstance, easingDecimal) {
          var defaultDrawTime = chartInstance.annotation.options.drawTime;
          helpers2.elements(chartInstance).filter(function(element2) {
            return drawTime === (element2.options.drawTime || defaultDrawTime);
          }).forEach(function(element2) {
            element2.transition(easingDecimal).draw();
          });
        };
      }
      return {
        beforeInit: function(chartInstance) {
          ...
          var ns = chartInstance.annotation = {
            elements: {},
            options: helpers2.initConfig(chartOptions.annotation || {}),
            onDestroy: [],
            firstRun: true,
            supported: false
          };
        ...
        beforeUpdate: function(chartInstance) {
          ...
          if (!ns.firstRun) {
            ns.options = helpers2.initConfig(chartInstance.options.annotation || {});
          } else {
            ns.firstRun = false;
          }
          var elementIds = [];
          ns.options.annotations.forEach(function(annotation2) {
            var id = annotation2.id || helpers2.objectId();
            if (!ns.elements[id] && annotationTypes[annotation2.type]) {
              var cls = annotationTypes[annotation2.type];
              var element2 = new cls({
                id,
                options: annotation2,
                chartInstance
              });
              element2.initialize();
              ns.elements[id] = element2;
              annotation2.id = id;
              elementIds.push(id);
        ...
        afterScaleUpdate: function(chartInstance) {
          helpers2.elements(chartInstance).forEach(function(element2) {
            element2.configure();
          });
        },
        ...
        afterInit: function(chartInstance) {
          ...
          if (chartHelpers.isArray(watchFor) && watchFor.length > 0) {
            ...
            var eventHandler = events2.dispatcher.bind(chartInstance);
            events2.collapseHoverEvents(watchFor).forEach(function(eventName) {
  ...
  function requireSrc() {
    ...
    Chart2.Annotation.Element = requireElement()(Chart2);
    Chart2.Annotation.types = {
      line: requireLine()(Chart2),
      box: requireBox()(Chart2)
    };
    var annotationPlugin = requireAnnotation()(Chart2);
    src = annotationPlugin;
...
//# sourceMappingURL=omnidb.chartjs.js.map
